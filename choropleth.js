d3.csv("candy.csv", function(err, data) {
    ...
    var config = {"color1":"#d3e5ff","color2":"#08306B","stateDataColumn":"STATE_PROVINCE_COUNTY_ETC","valueDataColumn":"population_estimate_for_july_1_2013_number"}
    ...
    .selectAll("option")
        ...
        .on("change", function() {
            ...
            amount = byCountry.rollup(function(v) {
                return d3.mean(v, function(f) {return v[value]});
            });
            config.valueDataColumn = amount;
        });
